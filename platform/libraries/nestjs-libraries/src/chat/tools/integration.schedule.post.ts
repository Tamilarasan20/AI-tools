import { AgentToolInterface } from '@loraloop/nestjs-libraries/chat/agent.tool.interface';
import { createTool } from '@mastra/core/tools';
import { z } from 'zod';
import { Injectable } from '@nestjs/common';
import { socialIntegrationList } from '@loraloop/nestjs-libraries/integrations/integration.manager';
...
import { AllProvidersSettings } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/all.providers.settings';
import { validate } from 'class-validator';
import { Integration } from '@prisma/client';
import { checkAuth } from '@loraloop/nestjs-libraries/chat/auth.context';

...
import { CreateAgencyDto } from '@loraloop/nestjs-libraries/dtos/agencies/create.agency.dto';
  ...
  async approveOrDecline(email: string, action: string, id: string) {
    ...
    if (action === 'approve') {
      await this._notificationService.sendEmail(
        agency?.user?.email!,
        'Your Agency has been approved and added to Loraloop 🚀',
        `
<html lang="en">
...
<head>
    ...
    <title>Your Agency has been approved and added to Loraloop 🚀</title>
</head>
...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
  Hi there, <br /><br />
  Your agency ${agency?.name} has been declined to Loraloop!<br />

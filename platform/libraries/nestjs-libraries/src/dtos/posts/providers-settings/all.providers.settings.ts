import { RedditSettingsDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/reddit.dto';
import { PinterestSettingsDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/pinterest.dto';
import { YoutubeSettingsDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/youtube.settings.dto';
import { TikTokDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/tiktok.dto';
import { XDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/x.dto';
import { LemmySettingsDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/lemmy.dto';
import { DribbbleDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/dribbble.dto';
import { DiscordDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/discord.dto';
import { SlackDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/slack.dto';
import { KickDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/kick.dto';
import { TwitchDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/twitch.dto';
import { InstagramDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/instagram.dto';
import { LinkedinDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/linkedin.dto';
...
import { HashnodeSettingsDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/hashnode.settings.dto';
import { WordpressDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/wordpress.dto';
import { ListmonkDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/listmonk.dto';
import { GmbSettingsDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/gmb.settings.dto';
import { FarcasterDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/farcaster.dto';
...
import { SkoolDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/skool.dto';
import { WhopDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/whop.dto';

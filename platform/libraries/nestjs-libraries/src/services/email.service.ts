...
import { EmailInterface } from '@loraloop/nestjs-libraries/emails/email.interface';
import { ResendProvider } from '@loraloop/nestjs-libraries/emails/resend.provider';
import { EmptyProvider } from '@loraloop/nestjs-libraries/emails/empty.provider';
import { NodeMailerProvider } from '@loraloop/nestjs-libraries/emails/node.mailer.provider';

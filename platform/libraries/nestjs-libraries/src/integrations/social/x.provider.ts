...
import {
  ...
  PostResponse,
  SocialProvider,
} from '@loraloop/nestjs-libraries/integrations/social/social.integrations.interface';
import { lookup } from 'mime-types';
import sharp from 'sharp';
import { readOrFetch } from '@loraloop/helpers/utils/read.or.fetch';
import { SocialAbstract } from '@loraloop/nestjs-libraries/integrations/social.abstract';
import { Plug } from '@loraloop/helpers/decorators/plug.decorator';
import { Integration } from '@prisma/client';
import { timer } from '@loraloop/helpers/utils/timer';
import { PostPlug } from '@loraloop/helpers/decorators/post.plug';
import dayjs from 'dayjs';
import { uniqBy } from 'lodash';
import { stripHtmlValidation } from '@loraloop/helpers/utils/strip.html.validation';
import { stripLinks as removeLinks } from '@loraloop/helpers/utils/strip.links';
import { XDto } from '@loraloop/nestjs-libraries/dtos/posts/providers-settings/x.dto';
import { Rules } from '@loraloop/nestjs-libraries/chat/rules.description.decorator';

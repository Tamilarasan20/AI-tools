...
# Copilot Coding Agent Instructions for Loraloop
...
- SDK (`apps/sdk`) provides programmatic access to Loraloop features.
...
## Documentation
- Main docs: https://docs.loraloop.com/
- Developer guide: https://docs.loraloop.com/developer-guide
- Public API: https://docs.loraloop.com/public-api

...
import { CreateOAuthAppDto } from '@loraloop/nestjs-libraries/dtos/oauth/create-oauth-app.dto';
import { UpdateOAuthAppDto } from '@loraloop/nestjs-libraries/dtos/oauth/update-oauth-app.dto';

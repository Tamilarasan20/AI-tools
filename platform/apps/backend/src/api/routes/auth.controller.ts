...
import { LoginUserDto } from '@loraloop/nestjs-libraries/dtos/auth/login.user.dto';
import { AuthService } from '@loraloop/backend/services/auth/auth.service';
import { ForgotReturnPasswordDto } from '@loraloop/nestjs-libraries/dtos/auth/forgot-return.password.dto';
import { ForgotPasswordDto } from '@loraloop/nestjs-libraries/dtos/auth/forgot.password.dto';
import { ResendActivationDto } from '@loraloop/nestjs-libraries/dtos/auth/resend-activation.dto';
...
export class AuthController {
  ...
  mobileCallback(
    ...
    const scheme = process.env.MOBILE_APP_SCHEME || 'loraloop://auth/callback';

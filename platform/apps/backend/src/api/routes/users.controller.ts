...
import { GetUserFromRequest } from '@loraloop/nestjs-libraries/user/user.from.request';
...
import { getCookieUrlFromDomain } from '@loraloop/helpers/subdomain/subdomain.management';
...
import { EmailNotificationsDto } from '@loraloop/nestjs-libraries/dtos/users/email-notifications.dto';
import { HttpForbiddenException } from '@loraloop/nestjs-libraries/services/exception.filter';
import { RealIP } from 'nestjs-real-ip';
import { UserAgent } from '@loraloop/nestjs-libraries/user/user.agent';
...
import { AuthorizationActions, Sections } from '@loraloop/backend/services/auth/permissions/permission.exception.class';

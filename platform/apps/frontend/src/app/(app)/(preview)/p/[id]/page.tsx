import { internalFetch } from '@loraloop/helpers/utils/internal.fetch';
import { sanitizePostContent } from '@loraloop/helpers/utils/sanitize.post.content';
...
import { CommentsComponents } from '@loraloop/frontend/components/preview/comments.components';
import dayjs from 'dayjs';
import utc from 'dayjs/plugin/utc';
import { VideoOrImage } from '@loraloop/react/helpers/video.or.image';
import { CopyClient } from '@loraloop/frontend/components/preview/copy.client';
import { getT } from '@loraloop/react/translation/get.translation.service.backend';
import { RenderPreviewDateClient } from '@loraloop/frontend/components/preview/render.preview.date.client';
import { CreationMethodBadge } from '@loraloop/frontend/components/launches/creation.method.badge';

dayjs.extend(utc);
export const metadata: Metadata = {
  title: `${isGeneralServerSide() ? 'Loraloop' : 'Loraloop'} Preview`,
  description: '',
};

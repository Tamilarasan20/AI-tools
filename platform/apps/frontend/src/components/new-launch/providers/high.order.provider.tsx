...
import { InternalChannels } from '@loraloop/frontend/components/launches/internal.channels';
...
export { PostComment } from '@loraloop/frontend/components/new-launch/providers/post-comment.enum';
import { PostComment } from '@loraloop/frontend/components/new-launch/providers/post-comment.enum';

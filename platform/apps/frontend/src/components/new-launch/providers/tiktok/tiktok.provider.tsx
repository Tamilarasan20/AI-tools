...
import { TiktokPreview } from '@loraloop/frontend/components/new-launch/providers/tiktok/tiktok.preview';
...
const TikTokSettings: FC<{
  ...
  const tiktokRestrictionNotice = useMemo(() => {
    ...
    return t(
      ...
      'TikTok restriction: For upload-only video, TikTok does not accept a title or message. The content will default to "#Loraloop" and you can edit it inside the TikTok app before publishing.'
    );

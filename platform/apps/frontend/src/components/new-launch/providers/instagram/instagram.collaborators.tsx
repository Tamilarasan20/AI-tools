...
import { InstagramCollaboratorsTags } from '@loraloop/frontend/components/new-launch/providers/instagram/instagram.tags';
import { useT } from '@loraloop/react/translation/get.transation.service.client';
import { InstagramPreview } from '@loraloop/frontend/components/new-launch/providers/instagram/instagram.preview';
const postType = [
  {
    value: 'post',
    label: 'Post / Reel',

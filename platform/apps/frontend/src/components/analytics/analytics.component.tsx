...
import { StarsAndForks } from '@loraloop/frontend/components/analytics/stars.and.forks';
import { FC, useCallback } from 'react';
import { StarsTableComponent } from '@loraloop/frontend/components/analytics/stars.table.component';

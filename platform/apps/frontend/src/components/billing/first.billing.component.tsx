...
import { LogoTextComponent } from '@loraloop/frontend/components/ui/logo-text.component';
import { pricing } from '@loraloop/nestjs-libraries/database/prisma/subscriptions/pricing';
import { capitalize } from 'lodash';
import clsx from 'clsx';
import { LoadingComponent } from '@loraloop/frontend/components/layout/loading';
import { CheckIconComponent } from '@loraloop/frontend/components/ui/check.icon.component';
import {
  FAQComponent,
  FAQSection,
} from '@loraloop/frontend/components/billing/faq.component';
import { useT } from '@loraloop/react/translation/get.transation.service.client';
import { useUser } from '@loraloop/frontend/components/layout/user.context';
import { useDubClickId } from '@loraloop/frontend/components/layout/dubAnalytics';
import SafeImage from '@loraloop/react/helpers/safe.image';
import { useModals } from '@loraloop/frontend/components/layout/new-modal';
import useCookie from 'react-use-cookie';
import { LogoutComponent } from '@loraloop/frontend/components/layout/logout.component';
import { DeveloperIconComponent } from '@loraloop/frontend/components/developer/developer.icon.component';
...
const EmbeddedBilling = dynamic(
  () =>
    import('@loraloop/frontend/components/billing/embedded.billing').then(
...
export const FirstBillingComponent = () => {
  ...
  const showYouTube = () => {
    modals.openModal({
      title: 'Grow Fast With Loraloop (Play the video)',
      children: (
        <iframe
          className="h-full aspect-video min-w-[800px]"
          src="https://www.youtube.com/embed/BdsCVvEYgHU?si=vvhaZJ8I5oXXvVJS?autoplay=1"
          title="Loraloop Tutorial"
          allow="autoplay"
          allowFullScreen
        />
      ),
      ...
      <>
        ...
        <div className="flex" onClick={showYouTube}>
          <div className="tablet:mb-[32px] cursor-pointer mt-[32px] flex gap-[10px] items-center underline hover:font-[700]">
            ...
            <div>See the power of Loraloop (click here)</div>
          </div>
        </div>
